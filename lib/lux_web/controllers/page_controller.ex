defmodule LuxWeb.PageController do
  ...
  @fb_callback Application.get_env(:lux, :facebook)[:callback_url]
  require IEx
  ...
  def member_dashboard(conn, _params) do
    render(conn, "member_dashboard.html", layout: {LuxWeb.LayoutView, "member.html"})
  end
