defmodule Cac.SettingsTest do
  ...
  describe "shop_products" do
    ...
    test "update_shop_product/2 with valid data updates the shop_product" do
      ...
      assert {:ok, %ShopProduct{} = shop_product} =
               Settings.update_shop_product(shop_product, @update_attrs)
    ...
    test "update_shop_product/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Settings.update_shop_product(shop_product, @invalid_attrs)
  ...
  describe "shop_product_tags" do
    ...
    test "create_shop_product_tag/1 with valid data creates a shop_product_tag" do
      assert {:ok, %ShopProductTag{} = shop_product_tag} =
               Settings.create_shop_product_tag(@valid_attrs)
    ...
    test "update_shop_product_tag/2 with valid data updates the shop_product_tag" do
      ...
      assert {:ok, %ShopProductTag{} = shop_product_tag} =
               Settings.update_shop_product_tag(shop_product_tag, @update_attrs)
    ...
    test "update_shop_product_tag/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Settings.update_shop_product_tag(shop_product_tag, @invalid_attrs)
    ...
    test "delete_shop_product_tag/1 deletes the shop_product_tag" do
      ...
      assert_raise Ecto.NoResultsError, fn ->
        Settings.get_shop_product_tag!(shop_product_tag.id)
      end
    end
  ...
  describe "facebook_pages" do
    ...
    test "update_facebook_page/2 with valid data updates the facebook_page" do
      ...
      assert {:ok, %FacebookPage{} = facebook_page} =
               Settings.update_facebook_page(facebook_page, @update_attrs)
    ...
    test "update_facebook_page/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Settings.update_facebook_page(facebook_page, @invalid_attrs)
  ...
  describe "live_videos" do
    ...
    @update_attrs %{
      ...
      description: "some updated description",
      embed_html: "some updated embed_html",
      facebook_page_id: 43,
      live_id: "some updated live_id",
    ...
    test "update_live_video/2 with valid data updates the live_video" do
      ...
      assert {:ok, %LiveVideo{} = live_video} =
               Settings.update_live_video(live_video, @update_attrs)
  ...
  describe "video_comments" do
    ...
    test "update_video_comment/2 with valid data updates the video_comment" do
      ...
      assert {:ok, %VideoComment{} = video_comment} =
               Settings.update_video_comment(video_comment, @update_attrs)
    ...
    test "update_video_comment/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Settings.update_video_comment(video_comment, @invalid_attrs)
  ...
  describe "page_visitors" do
    ...
    test "update_page_visitor/2 with valid data updates the page_visitor" do
      ...
      assert {:ok, %PageVisitor{} = page_visitor} =
               Settings.update_page_visitor(page_visitor, @update_attrs)
    ...
    test "update_page_visitor/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Settings.update_page_visitor(page_visitor, @invalid_attrs)
  ...
  describe "customer_orders" do
    ...
    @valid_attrs %{
      ...
      delivery_fee: 120.5,
      delivery_phone: "some delivery_phone",
      facebook_page_id: 42,
      grand_total: 120.5,
      page_visitor_id: 42,
      payment_gateway_link: "some payment_gateway_link",
      receipt_upload_link: "some receipt_upload_link",
    ...
    @update_attrs %{
      ...
      delivery_fee: 456.7,
      delivery_phone: "some updated delivery_phone",
      facebook_page_id: 43,
      grand_total: 456.7,
      page_visitor_id: 43,
      payment_gateway_link: "some updated payment_gateway_link",
      receipt_upload_link: "some updated receipt_upload_link",
    ...
    @invalid_attrs %{
      ...
      grand_total: nil,
      page_visitor_id: nil,
      payment_gateway_link: nil,
      receipt_upload_link: nil,
      remarks: nil,
      status: nil,
      sub_total: nil,
      user_id: nil
    ...
    test "create_customer_order/1 with valid data creates a customer_order" do
      assert {:ok, %CustomerOrder{} = customer_order} =
               Settings.create_customer_order(@valid_attrs)
    ...
    test "update_customer_order/2 with valid data updates the customer_order" do
      ...
      assert {:ok, %CustomerOrder{} = customer_order} =
               Settings.update_customer_order(customer_order, @update_attrs)
    ...
    test "update_customer_order/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Settings.update_customer_order(customer_order, @invalid_attrs)
  ...
  describe "customer_order_lines" do
    ...
    test "create_customer_order_line/1 with valid data creates a customer_order_line" do
      assert {:ok, %CustomerOrderLine{} = customer_order_line} =
               Settings.create_customer_order_line(@valid_attrs)
    ...
    test "update_customer_order_line/2 with valid data updates the customer_order_line" do
      ...
      assert {:ok, %CustomerOrderLine{} = customer_order_line} =
               Settings.update_customer_order_line(customer_order_line, @update_attrs)
    ...
    test "update_customer_order_line/2 with invalid data returns error changeset" do
      ...
      assert {:error, %Ecto.Changeset{}} =
               Settings.update_customer_order_line(customer_order_line, @invalid_attrs)
    ...
    test "delete_customer_order_line/1 deletes the customer_order_line" do
      ...
      assert {:ok, %CustomerOrderLine{}} =
               Settings.delete_customer_order_line(customer_order_line)

      assert_raise Ecto.NoResultsError, fn ->
        Settings.get_customer_order_line!(customer_order_line.id)
      end
    end
