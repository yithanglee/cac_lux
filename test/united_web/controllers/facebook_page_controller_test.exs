defmodule LuxWeb.FacebookPageControllerTest do
  ...
  describe "edit facebook_page" do
    ...
    test "renders form for editing chosen facebook_page", %{
      conn: conn,
  ...
  describe "update facebook_page" do
    ...
    test "redirects when data is valid", %{conn: conn, facebook_page: facebook_page} do
      conn =
        put(conn, Routes.facebook_page_path(conn, :update, facebook_page),
          facebook_page: @update_attrs
        )
