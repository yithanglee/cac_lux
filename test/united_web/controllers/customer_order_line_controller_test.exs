defmodule CacWeb.CustomerOrderLineControllerTest do
  ...
  describe "create customer_order_line" do
    test "redirects to show when data is valid", %{conn: conn} do
      conn =
        post(conn, Routes.customer_order_line_path(conn, :create),
          customer_order_line: @create_attrs
        )
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn =
        post(conn, Routes.customer_order_line_path(conn, :create),
          customer_order_line: @invalid_attrs
        )
  ...
  describe "edit customer_order_line" do
    ...
    test "renders form for editing chosen customer_order_line", %{
      conn: conn,
  ...
  describe "update customer_order_line" do
    ...
    test "redirects when data is valid", %{conn: conn, customer_order_line: customer_order_line} do
      conn =
        put(conn, Routes.customer_order_line_path(conn, :update, customer_order_line),
          customer_order_line: @update_attrs
        )

      assert redirected_to(conn) ==
               Routes.customer_order_line_path(conn, :show, customer_order_line)
  ...
  describe "delete customer_order_line" do
    ...
    test "deletes chosen customer_order_line", %{
      conn: conn,
      customer_order_line: customer_order_line
    } do
