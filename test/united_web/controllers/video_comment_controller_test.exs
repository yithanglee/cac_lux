defmodule LuxWeb.VideoCommentControllerTest do
  use LuxWeb.ConnCase
  ...
  describe "edit video_comment" do
    ...
    test "renders form for editing chosen video_comment", %{
      conn: conn,
  ...
  describe "update video_comment" do
    ...
    test "redirects when data is valid", %{conn: conn, video_comment: video_comment} do
      conn =
        put(conn, Routes.video_comment_path(conn, :update, video_comment),
          video_comment: @update_attrs
        )
