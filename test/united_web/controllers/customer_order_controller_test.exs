defmodule CacWeb.CustomerOrderControllerTest do
  ...
  describe "edit customer_order" do
    ...
    test "renders form for editing chosen customer_order", %{
      conn: conn,
  ...
  describe "update customer_order" do
    ...
    test "redirects when data is valid", %{conn: conn, customer_order: customer_order} do
      conn =
        put(conn, Routes.customer_order_path(conn, :update, customer_order),
          customer_order: @update_attrs
        )
