defmodule CacWeb.LiveVideoControllerTest do
  ...
  describe "update live_video" do
    ...
    test "redirects when data is valid", %{conn: conn, live_video: live_video} do
      conn =
        put(conn, Routes.live_video_path(conn, :update, live_video), live_video: @update_attrs)
    ...
    test "renders errors when data is invalid", %{conn: conn, live_video: live_video} do
      conn =
        put(conn, Routes.live_video_path(conn, :update, live_video), live_video: @invalid_attrs)
